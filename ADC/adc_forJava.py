...
def predict(argument):
    ...
    model.load_model("/Users/wzx/python-workspace/lol2/ADC/adc.model")  # load data
    ...
    test = pd.DataFrame({'Kills per min.': [argument[0]],
                         ...
                         'Total healing per min.': [argument[11]],

                         'Damage to turrets per min': [argument[12]],
                         'Total damage taken per min.': [argument[13]],

                         'Gold earned per min.': [argument[14]],
                         'Total minions killed per min.': [argument[15]],

                         'turretkills': [argument[16]],
                         'inhibkills': [argument[17]],
                         })
