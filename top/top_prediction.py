...
model.load_model("top.model")  # load data

test = pd.DataFrame({'Kills per min.':[0.3928],
                     'Deaths per min.':[0.107],
                     'Assists per min.':[0.1786],
                    'largestkillingspree':[0.178],
                     'largestmultikill':[3],


                     'Double kills per min.':[0.07],
                     'Triple kills per min.':[0.035],
                     'Quadra kills per min.':[0],
                     'Penta kills per min.':[0],

                     'Total damage dealt per min.':[4642],

                     'Total damage to champions per min.':[607],


                     'Damage to turrets per min':[200],
                     'Total damage taken per min.':[400],

                     'Gold earned per min.':[464],
                     'Total minions killed per min.':[6.5],

                     'turretkills':[1],
                     'inhibkills':[2],
                     'Wards placed per min.':[0]
                    })
