...
X = top.drop(["matchid","wardsbought","win","role","position","id_x","player","championid","ss1","ss2","role",
                   ...
                   , "ownjunglekills","enemyjunglekills","firstblood","wardskilled","pinksbought","totheal","visionscore"
...
params = {
    ...
    "min_child_weight": 10,  # 这个参数用于避免过拟合。当它的值较大时，可以避免模型学习到局部的特殊样本。
